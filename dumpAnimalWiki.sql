...
CREATE TABLE definicao (definicao_id CHARACTER VARYING(255) NOT NULL, avaliacao CHARACTER VARYING(255), animal_id CHARACTER VARYING(255) NOT NULL, PRIMARY KEY (definicao_id));
